...
use_discrete=1
distributed_dp=1
num_colluding_clients=5 #num_colluding_clients=5
...
path/to/env/bin/python3.8 path/to/this_repo/server_distributed_dp.py \
...
--global_output_dir checkpoints/${dataset_name}_${model_name_or_path}_${method_type}_private_transformer_max${max_seq_length}_use_discrete${use_discrete}_distributed${distributed_dp}_num_colluding${num_colluding_clients}_${SLURM_ARRAY_TASK_ID}/ \
--freeze_non_prompt_layers 0 --use_discrete ${use_discrete} --distributed_dp ${distributed_dp} --num_colluding_clients ${num_colluding_clients}
